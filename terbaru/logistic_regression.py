...
with open('train_data_logistic_regression.json', 'w') as train_file:
...
with open('test_data_logistic_regression.json', 'w') as test_file:
...
# Simpan evaluasi model Logistic Regression ke dalam file JSON
with open('logistic_regression_evaluation.json', 'w') as nb_eval_file:
    json.dump(logistic_regression_evaluation, nb_eval_file, indent=4)
...
# Simpan hasil klasifikasi dari model Logistic Regression ke dalam file JSON
with open('logistic_regression_results.json', 'w') as nb_file:
    json.dump(logistic_regression_results, nb_file, indent=4)
